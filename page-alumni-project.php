...
<style>
    ...
    body { background-color: #fdfdfd; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333; }
    ...
    .hero-lp h1 { font-size: 52px; color: #2d2424; margin-bottom: 10px; font-weight: bold; }
    .hero-lp h1 span { font-style: italic; font-weight: normal; }
    .hero-lp p { font-size: 16px; color: #666; max-width: 600px; margin: 0 auto 30px; line-height: 1.6; }
    ...
    .program-header h2 { font-size: 32px; margin: 0; }
    .program-header p { color: #666; margin: 10px 0 0 0; max-width: 500px; }
    ...
    .p-card-body h3 { font-size: 20px; margin: 15px 0 10px; font-family: 'Segoe UI', sans-serif; font-weight: 700; }
    .p-card-body p { font-size: 14px; color: #666; line-height: 1.6; margin-bottom: 20px; }
    .p-card-link { font-size: 13px; font-weight: 700; color: #333; text-decoration: none; text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    .kolaborasi-text h2 { font-size: 36px; line-height: 1.2; margin-bottom: 20px; color: #2d2424; }
    .kolaborasi-text p { color: #666; line-height: 1.7; margin-bottom: 25px; }
    .kolaborasi-list { list-style: none; padding: 0; margin: 0 0 30px 0; }
    .kolaborasi-list li { position: relative; padding-left: 30px; margin-bottom: 15px; font-size: 15px; color: #444; font-weight: 600; }
    ...
    .floating-card .f-text { font-weight: 700; font-size: 16px; color: #333; }
    ...
    .progress-text { font-size: 12px; color: #888; text-align: right; width: 100%; display: block; font-weight: 600; }
    ...
    .mitra-label { font-size: 11px; text-transform: uppercase; color: #999; letter-spacing: 2px; margin-bottom: 20px; }
    ...
    .siap-kolaborasi h2 { font-size: 32px; color: #2d2424; margin-bottom: 10px; }
    .siap-kolaborasi > p { color: #666; margin-bottom: 30px; }
    ...
    .sk-card h3 { font-family: 'Segoe UI', sans-serif; font-size: 18px; font-weight: 700; margin-bottom: 15px; }
    .sk-card p { font-size: 14px; color: #666; line-height: 1.6; margin-bottom: 20px; }
    ...
    .bb-text h2 { font-size: 28px; margin: 0 0 10px 0; }
    .bb-text p { margin: 0; color: #666; font-size: 15px; max-width: 400px; }
